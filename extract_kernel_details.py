...
#
# Copyright (c) 2022-2026 Carsten Grohmann and contributors
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--version",
        action="version",
        version="extract_kernel_details.py version 0.2 - Copyright (c) 2022-2026 Carsten Grohmann and contributors",
    )
